...
const useScheduleRows: React.FC<ScheduleTableProps> = ({
    ...
    (vehicle: VehicleProps, idx) => {
      ...
      const scheduleCells = weekDates.map((date: string, index: number) => {
        ...
        if (schedule) {
          ...
          //       className="w-[110px] cursor-pointer hover:scale-105 transition-transform duration-300 max-h-fit py-2 border-b border-b-slate-300 relative"
          //     >
          //       {/* <ResizableItem
          //         key={date}
          //         index={index}
          ...
          //         day="first"
          //       />
          //       <div className="bg-blue-300 ml-[10px] h-[55px] rounded-l-md p-[5px] z-20 relative">
          ...
          //             className="bg-blue-300 ml-[10px] h-[55px] rounded-l-md p-[5px] z-20 relative"
          //           >
          //             <p className="text-[10px] font-bold">{schedule.driver}</p>
          //             <p className="text-[10px] font-normal">
          //               {schedule.client}
          ...
          //         key={date}
          //         // onClick={handleScheduleClick}
          //         className=" w-[110px] cursor-pointer transition-transform duration-300 max-h-fit rounded-md py-2 border-b border-b-slate-300 relative"
          //         ref={provided.innerRef}
          //         {...provided.draggableProps}
          //         {...provided.dragHandleProps}
          //       >
          ...
          //       // {...provided.draggableProps}
          //       // {...provided.dragHandleProps}
          //       className="bg-blue-300 ml-[10px] h-[55px] rounded-md p-[5px] flex flex-col justify-center z-20 relative"
          //     >
          //       <p className="text-[10px] font-bold">{schedule.driver}</p>
          //       <p className="text-[10px] font-normal">{schedule.client}</p>
          //       <p className="text-[10px] font-normal">
  ...
  // return <tbody>{scheduleRows}</tbody>;
  // return <>{scheduleRows}</>;
};
