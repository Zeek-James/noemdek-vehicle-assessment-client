...
//             <tr>
//               <th className="border-r-2 border-slate-300 border-b-2 border-b-slate-500">
//                 <div className="text-xs font-semibold">Vehicles</div>
//               </th>
//               <th className="border-r-2 border-slate-300 border-b-2 border-b-slate-500">
//                 {/* <div className="text-xs font-semibold">Vehicles</div> */}
//                 <div className="flex">
...
//                 </div>
//               </th>
//               {/* <th className="flex w-full bg-green-300 justify-between text-center border-b-2 border-slate-500">
//                 {weekDates.map((date) => (
//                   <p
//                     key={date}
//                     className="  w-full   text-xs font-semibold items-center justify-center"
//                   >
//                     {new Date(date).toLocaleDateString("en-US", {
//                       weekday: "short",
//                       day: "numeric",
...
//                 ))}
//               </th> */}
//               <div className="border-r-2 min-h-[20px] border-slate-300 flex border-b-2 border-b-slate-500">
//                 <th className="flex">
//                   {weekDates.map((date) => (
//                     <div className="text-xs font-semibold ">Vehicles</div>
//                   ))}
